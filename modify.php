...
<body>
    ...
    <div id="page" class="container">
        ...
        <div id="main" style="margin-top: 70px;">
            <form method="post" action="m_personal.php" id="myform">
                <ul class="style1">
                    <li class="first">
                    ...
                    <li class="first">
                        ...
                        <br>
                        <input id="name" name="userName" style="font-size: 30px;" value="<?php echo $myname ?>">
                    </li>
                    <li class="first">
                        <p class="date" style="font-size: 20px;">信箱</p>
                        <br>
                        <input type="mail" id="userMail" name="userMail" style="font-size: 30px;" value="<?php echo $mail ?>">
                    </li>
                    <li class="first">
                        <p class="date" style="font-size: 20px;">電話</p>
                        <br>
                        <input id="phone" name="userPhone" style="font-size: 30px;" value="<?php echo $phone ?>">
                    </li>
                    <input onclick="submit()" type="button" style="margin-left: 100px; font-size: 20px" value="儲存更改"/>
                    <input onclick="return1()" type="button" style="margin-left: 100px; font-size: 20px" value="返回">
                </ul>
            </form>
        </div>
    </div>
